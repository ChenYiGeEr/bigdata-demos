...
FRIEND_NAME=notice-demo
MAIN_CLASS=com.lim.demos.notice.NoticeServiceApplication
if [ ! ${ENV_FILE} ]; then
...
JAVA_OPTS=${JAVA_OPTS}" -Dserver.port="${SERVER_PORT}" -Ddata.path="${DATA_PATH}"  -Dspring.profiles.active="${PROFILES_ACTIVE}
