...
public class ImmutablePriorityPropertyDelegate extends ImmutablePropertyDelegate {
    ...
    private static final Map<String, Optional<ConfigValue<String>>> CONFIG_VALUE_MAP = new ConcurrentHashMap<>();
    ...
    public String get(String key) {
        Optional<ConfigValue<String>> configValue = CONFIG_VALUE_MAP.computeIfAbsent(key, k -> {
