...
import com.lim.demos.mapreduce.mapper.PhoneFlowMapper;
import com.lim.demos.mapreduce.partition.PhoneFlowPartitioner;
import com.lim.demos.mapreduce.reducer.PhoneFlowReducer;
...
public class PhoneFlowDriver {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        FileOutputFormat.setOutputPath(job, new Path("/Users/lim/代码/mine/mapreduce-demo/output2"));
        // 3. 运行job
